                                                        ...
                                                        <table id="datatable-buttons" class="table table-striped jambo_table bulk_action" style="width:100%">
                                                          <thead>
                                                            <tr class="headings">
                                                              ...
                                                              <th class="column-title rhead">Action</th>
                                                            </tr>
                                                          </thead>
                                                          ...
                                                          <tbody>
                                                            ...
                                                            <tr>
                                                              <td><?php echo $company_name; ?></td>
                            									                ...
                            									                <td>
                                                                <b class="text-info">68</b>
                                                                </br>
                                                                <?php echo $total_units; ?> - <?php echo number_format($total_stocks_value, 2); ?>
                                                              </td>
                            																	<td>
                                                                <b class="text-success">68</b>
                                                                </br>
                                                                <?php echo $available_stocks_count; ?> - <?php echo number_format($available_stocks_value, 2); ?>
                                                              </td>
                            									                <td>
                                                                <b class="text-danger">68</b>
                                                                </br>
                                                                <?php echo $Sold_stocks_count; ?> - <?php echo number_format($Sold_stocks_value, 2); ?>
                                                              </td>
                                                              <td>
                                                                <a href="view_selected_stock.php"><button type="button" class="btn btn-sm btn-edit ">View</button></a>
                                                              </td>
                                                            </tr>
                                                            <?php
                              									        }
