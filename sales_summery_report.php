...
<html lang="en">
  <head>
    ...
    <title>Sales Summery List | Quick Track Admin - Kelsey Developments PLC</title>
                                     ...
                                     <div class="col-md-12 ">
                                         <div class="x_content">
                                           <form class="form-label-left input_mask" method="get" id="filterForm" action="filter-collection-script.php" enctype="multipart/form-data">
                                                           <div class="col-md-1 col-sm-12  form-group-report" style="padding: 0px;margin-top: 28px;">
                                                           ...
                                                           <div class="col-md-2 col-sm-12  form-group-report">
                                                            ...
                                                            <div class="col-md-2 col-sm-12  form-group-report">
                                                              <label for="selectperson">Select Sales Person </label>
                                                              <select id="company-select" class="form-control report" name="formSalesPerson">
                                                            ...
                                                            <div class="col-md-1 col-sm-12  form-group-report" style="margin-top: 27px;">
